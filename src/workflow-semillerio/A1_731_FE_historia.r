...
PARAM <- list()
PARAM$experimento <- "A1_FE7310"

PARAM$exp_input <- "A1_DR7210"
...
PARAM$RandomForest$semilla <- 251033 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 251051
