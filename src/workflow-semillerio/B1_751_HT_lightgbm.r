...
PARAM <- list()
PARAM$experimento <- "B1_HT7510"

PARAM$exp_input <- "B1_TS7410"

# En caso que se haga cross validation, se usa esta cantidad de folds
PARAM$lgb_crossvalidation_folds <- 5

PARAM$lgb_semilla <- 251033 # cambiar por su propia semilla
...
PARAM$lgb_basicos <- list(
  ...
  pos_bagging_fraction = 0.7, # 0.0 < pos_bagging_fraction <= 1.0
