...
PARAM <- list()
PARAM$experimento <- "A1_TS7410"

PARAM$exp_input <- "A1_FE7310"
...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202002, 202001, 201912,
  201911, 201910, 201909
)

PARAM$train$training <- c(
  202101, 202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004,
  202002, 202001, 201912, 201911,
  201910, 201909, 201908, 201907, 201906, 201905, 201904, 201903
)

PARAM$train$validation <- c(202102)
PARAM$train$testing <- c(202103, 202105, 202107)
...
PARAM$train$semilla <- 251033 # cambiar por su propia semilla  !!!
