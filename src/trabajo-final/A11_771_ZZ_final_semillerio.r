...
PARAM$semillerio <- 38  #inicialmente puse semillerio 50 pero el hibrido (archivo H5) lo realice con el archivo que se genero cuando iba por el semillerio 38 
